...
const InactivityWarningModal: React.FC<InactivityWarningModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 overflow-y-auto z-50 flex items-center justify-center bg-black bg-opacity-50 p-4">
      <div className="bg-sand border-4 border-maineBlue rounded-lg p-4 lg:p-6 max-w-md w-full mx-4 shadow-2xl">

      ...
      <div className="bg-white rounded-lg shadow-lg border-4 border-maineBlue p-4 lg:p-6 w-full max-w-6xl mx-auto">
        ...
        <div className={`${activeMobileTab === 'home' ? 'block' : 'hidden'} lg:block`}>
          ...
          <div className="mb-4 p-3">
            ...
            <Link
              to="/src/disciplines/manufacturing/modules/MyFloor"
            ...
            <Link
              to="/src/disciplines/manufacturing/modules/MyPlaybook"
            ...
            <Link
              to="/src/disciplines/manufacturing/modules/ShopTalk"
            ...
            <Link
              to="/src/disciplines/manufacturing/modules/MfgAcademy"

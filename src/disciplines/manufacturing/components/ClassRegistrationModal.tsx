  ...
  const handleSubmit = async () => {
    ...
    try {
      const { error } = await supabase.from('user_activity_log').insert({
        user_id: user.id, activity_type: 'class_registration', discipline: 'manufacturing',
...
MFG 101 - Shop Safety
                  ...
                  <div className="text-sm text-gray-600">Monday 9:00 AM - 11:00 AM • Shop A</div>
...
MFG 205 - CNC Operations
                  </label>
                  <div className="text-sm text-gray-600">Wednesday 1:00 PM - 4:00 PM • Shop B</div>
...
MFG 301 - Advanced Manufacturing
                  </label>
                  <div className="text-sm text-gray-500">Tuesday 2:00 PM - 5:00 PM • Shop C</div>
            ...
            <div className="text-xs text-red-600 ml-7">✗ {t('registration.requires')} MFG 201 (Basic Manufacturing)</div>
          </div>
        </div>

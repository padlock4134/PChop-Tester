        ...
        {!knifeSelected && (
          <div className="absolute inset-0 flex items-center justify-center z-10 pointer-events-none">
            <div className="bg-black bg-opacity-60 text-white px-6 py-4 rounded-xl text-center animate-pulse">
              <p className="text-lg font-bold">👆 Tap to pick up tester & panel target</p>
            </div>
          </div>
        )}
          ...
          dangerouslySetInnerHTML={{
            ...
            >
              ...
              >
                ...
                ></a-box>
                <a-box position="-0.12 0.08 0.01" width="0.1" height="0.03" depth="0.02" color="#EF4444"></a-box>
                <a-box position="0 -0.03 0.01" width="0.28" height="0.2" depth="0.02" color="#111827"></a-box>
              </a-plane>` : ''}

              <!-- Left hand holding panel target -->
              ${whetstoneSelected ? `
              <a-entity 
              ...
              >
                <a-box 
                  ...
                  depth="0.03"
                  color="#FBBF24"
                  material="shader: standard; roughness: 0.65"
                ></a-box>
                <a-box 
                  position="0 0.27 0" 
                  width="0.012" 
                  ...
                  depth="0.012"
                  color="#D1D5DB"
                  material="shader: standard; roughness: 0.35; metalness: 0.8"
                ></a-box>

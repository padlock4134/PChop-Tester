...
const navItems = [
  { path: '/my-dock', label: 'My Dock' },
  { path: '/logistics-school', label: 'Logistics School' },
  { path: '/my-runbook', label: 'My Runbook' },
  { path: '/dispatchers-corner', label: 'Dispatchers Corner' },
];
      ...
      <div className="max-w-5xl mx-auto px-4">
        ...
        <div className="flex items-center justify-between w-full">
          ...
          <div className="flex items-center space-x-2">
            ...
            {/* Profile Avatar */}
            <Link
              to={location.pathname.includes('/profile') ? (disciplineConfig?.routes.dashboard ?? '/') : (disciplineConfig?.routes.profile ?? '/profile')}
              className={`relative flex items-center justify-center w-10 h-10 rounded-full shadow cursor-pointer transition-colors border-2 border-black ${

...
const StudentProgressDashboard: React.FC = () => {
  ...
  const progressData = {
    curriculum: {
      completedLessons: 12,
      totalLessons: 24,
      currentLesson: "Route Optimization Fundamentals",
    ...
    insights: {
      ...
      improvementArea: "Dock Timing Coordination",
      learningVelocity: "Above Average",
      achievements: ["Safety Certified", "On-Time Specialist", "Team Coordinator"]
    }
  };
      ...
      <div className="bg-white rounded-lg shadow-lg border-4 border-maineBlue p-4 lg:p-6 w-full max-w-6xl mx-auto">
        ...
        <div className={`${activeMobileTab === 'home' ? 'block' : 'hidden'} lg:block`}>
          ...
          <div className="text-center mb-6">
            <h1 className="text-4xl font-retro text-maineBlue mb-2">Dockmaster Dashboard</h1>
          ...
          <div className="mb-4 p-3">
            ...
            >
              <div className="mb-3 text-4xl">📖</div>
              <h3 className="text-sm font-bold font-retro">{t('myRunbook.title')}</h3>
            </Link>
            
            <Link
              to="/logistics/dispatch-lounge"
            ...
            >
              <div className="mb-3 text-4xl">📦</div>
              <h3 className="text-sm font-bold font-retro">{t('dispatchLounge.title')}</h3>
            </Link>
            
            <Link
              to="/logistics/logistics-school"
            ...
            >
              <div className="mb-3 text-4xl">🚢</div>
              <h3 className="text-sm font-bold font-retro">{t('logisticsSchool.title')}</h3>
            </Link>
          </div>
          </div>
        </div>

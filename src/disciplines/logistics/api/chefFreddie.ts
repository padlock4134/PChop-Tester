// Anthropic Claude Haiku API integration for Lou the Dispatcher
import { supabase } from './supabaseClient';
import { isSessionValid } from './userSession';

export async function askDispatcherFreddie(userId: string, prompt: string): Promise<string> {
  // --- Chat limit logic ---
  ...
  const systemPrompt = `You are Lou the Dispatcher, a friendly and knowledgeable AI logistics assistant for the PorkChop platform.

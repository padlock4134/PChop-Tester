...
export const BADGES: BadgeDefinition[] = [
  ...
  // --- MILESTONE BADGES (20) ---
  { id: 'shipment_novice', name: 'Project Novice', icon: '🍽️', category: 'Milestone', description: 'Completed 10 projects.' },
  { id: 'shipment_apprentice', name: 'Project Apprentice', icon: '🍽️', category: 'Milestone', description: 'Completed 25 projects.' },
  { id: 'shipment_pro', name: 'Project Pro', icon: '🍽️', category: 'Milestone', description: 'Completed 50 projects.' },
  { id: 'shipment_veteran', name: 'Project Veteran', icon: '🍽️', category: 'Milestone', description: 'Completed 100 projects.' },
  { id: 'shipment_hero', name: 'Project Hero', icon: '🍽️', category: 'Milestone', description: 'Completed 200 projects.' },
  { id: 'shipment_master', name: 'Project Master', icon: '🍽️', category: 'Milestone', description: 'Completed 300 projects.' },
  { id: 'shipment_legend', name: 'Project Legend', icon: '🍽️', category: 'Milestone', description: 'Completed 400 projects.' },
  { id: 'shipment_icon', name: 'Project Icon', icon: '🍽️', category: 'Milestone', description: 'Completed 500 projects.' },
  { id: 'shipment_champion', name: 'Project Champion', icon: '🍽️', category: 'Milestone', description: 'Completed 750 projects.' },
  { id: 'shipment_god', name: 'Project God', icon: '🍽️', category: 'Milestone', description: 'Completed 1000 projects.' },
  { id: 'runbook_5', name: 'Project Collector', icon: '📚', category: 'Milestone', description: 'Added 5 projects to your playbook.' },
  { id: 'runbook_10', name: 'Project Curator', icon: '📚', category: 'Milestone', description: 'Added 10 projects to your playbook.' },
  { id: 'runbook_20', name: 'Project Librarian', icon: '📚', category: 'Milestone', description: 'Added 20 projects to your playbook.' },
  { id: 'runbook_40', name: 'Project Archivist', icon: '📚', category: 'Milestone', description: 'Added 40 projects to your playbook.' },
  ...
  // --- COMMUNITY BADGES (14) ---
  { id: 'route_sharer_1', name: 'Project Sharer', icon: '📤', category: 'Community', description: 'Shared your first project.' },
  { id: 'route_sharer_5', name: 'Project Contributor', icon: '📤', category: 'Community', description: 'Shared 5 projects.' },
  { id: 'route_sharer_10', name: 'Project Publisher', icon: '📤', category: 'Community', description: 'Shared 10 projects.' },
  { id: 'route_sharer_25', name: 'Project Influencer', icon: '📤', category: 'Community', description: 'Shared 25 projects.' },
  { id: 'route_sharer_50', name: 'Project Mentor', icon: '📤', category: 'Community', description: 'Shared 50 projects.' },
  ...
  { id: 'dispatcher_of_the_year', name: 'Builder of the Year', icon: '🏅', category: 'Special', description: 'Earned the most badges in a year.' },
  { id: 'legendary_dispatcher', name: 'Legendary Builder', icon: '🐉', category: 'Special', description: 'Unlocked all milestone badges.' },
];

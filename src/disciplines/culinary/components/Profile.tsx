...
const Profile = () => {
  ...
  const talentTrees = {
    'Knife Skills': [
      { name: 'Cast Iron Champion', icon: FireIcon, unlockLevel: 10, description: 'Master the art of cast iron cooking' },
      { name: 'Seasoned Veteran', icon: TrophyIcon, unlockLevel: 14, description: 'Expert in maintaining cookware' },
      { name: 'Rustproof', icon: ShieldCheckIcon, unlockLevel: 25, description: 'Never let your tools deteriorate' },
      { name: 'Heavy Hitter', icon: FireIcon, unlockLevel: 30, description: 'Wield heavy cookware with ease' },
      { name: 'Surface Sage', icon: StarIcon, unlockLevel: 36, description: 'Know every cooking surface' },
      { name: 'Proofing Pro', icon: StarIcon, unlockLevel: 42, description: 'Perfect dough proofing every time' },
      { name: 'Pastry Pro', icon: CakeIcon, unlockLevel: 48, description: 'Master of pastry techniques' },
      { name: 'Iron Chef', icon: TrophyIcon, unlockLevel: 55, description: 'Ultimate cooking mastery' },
      { name: 'Baking Warlock', icon: TrophyIcon, unlockLevel: 60, description: 'Magical baking abilities' },
    ],
    'Heat Control': [
      { name: 'Grilling Heavyweight', icon: FireIcon, unlockLevel: 10, description: 'Master of the grill' },
      { name: 'Baking Warlock', icon: CakeIcon, unlockLevel: 14, description: 'Oven temperature expert' },
      { name: 'Sear Savant', icon: StarIcon, unlockLevel: 25, description: 'Perfect sear every time' },
      { name: 'Heat Control', icon: ShieldCheckIcon, unlockLevel: 30, description: 'Precise temperature management' },
      { name: 'Flame Tamer', icon: FireIcon, unlockLevel: 36, description: 'Control any heat source' },
      { name: 'Smoke Master', icon: SparklesIcon, unlockLevel: 42, description: 'Expert in smoking techniques' },
      { name: 'Char Champion', icon: StarIcon, unlockLevel: 48, description: 'Perfect char marks' },
      { name: 'Grill Marks', icon: StarIcon, unlockLevel: 55, description: 'Beautiful grill presentation' },
      { name: 'BBQ God', icon: TrophyIcon, unlockLevel: 60, description: 'Ultimate BBQ mastery' },
    ],
    'Pastry Arts': [
      { name: 'Pastry Warlock', icon: CakeIcon, unlockLevel: 10, description: 'Unlock the secrets of baking with precision measurements, perfect timing, and delicious results' },
      { name: 'Dough Whisperer', icon: CakeIcon, unlockLevel: 14, description: 'Understand dough like no other' },
      { name: 'Oven Oracle', icon: ShieldCheckIcon, unlockLevel: 25, description: 'Predict perfect baking times' },
      { name: 'Prep Pro', icon: StarIcon, unlockLevel: 30, description: 'Expert in food preparation and setup' },
      { name: 'Garnish Conjurer', icon: CakeIcon, unlockLevel: 36, description: 'Flawless garnishes every time' },
      { name: 'Cooking Sense', icon: SparklesIcon, unlockLevel: 42, description: 'Sense when food is perfectly cooked' },
      { name: 'Flavor Fiend', icon: CakeIcon, unlockLevel: 48, description: 'Master of flavors and seasonings' },
      { name: 'Presentation Buffoon', icon: AcademicCapIcon, unlockLevel: 55, description: 'Master of beautiful food presentation' },
      { name: 'Culinary Warlock', icon: TrophyIcon, unlockLevel: 60, description: 'Ultimate culinary mastery' },
    ],
  };
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-lg shadow-lg border-4 border-black p-4 sm:p-6 w-full max-w-4xl max-h-[85vh] lg:max-h-[80vh] overflow-y-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
              {talentTrees[selectedTalentTree === 'Knife Skills' ? 'Knife Skills' : 
                           selectedTalentTree === 'Heat Control' ? 'Heat Control' : 'Pastry Arts']?.map(talent => {

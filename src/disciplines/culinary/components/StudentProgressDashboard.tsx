...
const StudentProgressDashboard: React.FC = () => {
  ...
  return (
    <div className="mb-8 mx-auto">
      ...
      {/* Main Dashboard */}
      <div className="bg-white rounded-lg shadow-lg border-4 border-maineBlue p-4 lg:p-6 w-full desktop-dashboard-frame student-dashboard-frame culinary-frame-lock">
        {/* Home Tab Content */}

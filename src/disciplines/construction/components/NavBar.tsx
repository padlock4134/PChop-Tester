...
const navItems = [
  { path: '/construction/my-site', label: 'My Site' },
  { path: '/construction/build-school', label: 'Build School' },
  { path: '/construction/my-blueprints', label: 'My Blueprints' },
  { path: '/construction/hardhat-hub', label: 'Hardhat Hub' },
];
    ...
    <button
      onClick={() => {
        if (isOnAdmin) {
          ...
          navigate(disciplineConfig?.routes.dashboard || '/construction/dashboard');
        } else {
      ...
      <div className="max-w-5xl mx-auto px-4">
        ...
        <div className="flex items-center justify-between w-full">
          <div className="flex items-center space-x-2 ml-[5%]">
            ...
            <Link 
              to={isAdminMode ? "/admin" : (disciplineConfig?.routes.dashboard || '/construction/dashboard')} 
          ...
          <div className="flex items-center space-x-2">
            ...
            {/* Profile Avatar */}
            <Link
              to={location.pathname.includes('/profile') ? (disciplineConfig?.routes.dashboard || '/construction/dashboard') : (disciplineConfig?.routes.profile || '/construction/profile')}
              className={`relative flex items-center justify-center w-10 h-10 rounded-full shadow cursor-pointer transition-colors border-2 border-black ${

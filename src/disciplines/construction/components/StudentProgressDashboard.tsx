      ...
      <div className="bg-white rounded-lg shadow-lg border-4 border-maineBlue p-4 lg:p-6 w-full max-w-6xl mx-auto">
        ...
        <div className={`${activeMobileTab === 'home' ? 'block' : 'hidden'} lg:block`}>
          ...
          <div className="text-center mb-6">
            <h1 className="text-4xl font-retro text-maineBlue mb-2">Site Foreman Dashboard</h1>
          ...
          <div className="mb-4 p-3">
            ...
            >
              ...
              <h3 className="text-sm font-bold font-retro">{t('mySite.title')}</h3>
            </Link>
            ...
            >
              <div className="mb-3 text-4xl">⛑️</div>
              <h3 className="text-sm font-bold font-retro">{t('hardhatHub.title')}</h3>
            </Link>

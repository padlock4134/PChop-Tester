...
import './FlippableBlueprints.css';
...
const PAGES = [
    ...
    content: (
      <>
        <div style={{ 
          ...
          <h2 className="cover-subtitle" style={{ fontSize: '1.8rem', margin: '0 0 2rem 0', color: '#fff', textAlign: 'center' }}>Your AI Construction Training Companion</h2>
    ...
    content: (
      <div className="toc-content">
        <ul className="toc-list">
          ...
          <li>My Site (Page 3)</li>
          <li>My Blueprints (Page 4)</li>
          <li>Build School (Page 5)</li>
          <li>Hardhat Hub (Page 6)</li>
          <li>Foreman Frank (Page 7)</li>
    ...
    content: (
      <>
        ...
        <p className="page-content-text">
          We created PorkChop because my grandfather Frederick always knew the right way to build things — from framing a wall to reading a blueprint.
          He taught us that every great structure starts with a solid plan and the right team.
          His lessons stuck: measure twice, cut once, and always leave things better than you found them.
        </p>
      </>
    ),
    pageNumber: 2
  ...
  // Page 3 - My Site
  {
    ...
    content: (
      <>
        <p className="page-content-text">
          Your digital site tracker that manages materials and suggests the right approach for any build project.
        </p>
        <div className="page-image-container page-3-image">
          <img src="/my-kitchen-screenshot.png" alt="My Site Screenshot" className="page-screenshot" />
        </div>
      </>
    ),
    pageNumber: 3
  },
  // Page 4 - My Blueprints
  {
    title: "My Blueprints",
    content: (
      <>
        <p className="page-content-text">
          Your personal build plan portfolio — blueprints, project specs, and completed work orders in one place.
        </p>
        <div className="page-image-container page-4-image">
          <img src="/my-cookbook-screenshot.png" alt="My Blueprints Screenshot" className="page-screenshot" />
        </div>
      </>
    ),
    pageNumber: 4
  ...
  // Page 5 - Build School
  {
    ...
    content: (
      <>
        <p className="page-content-text">
          Master construction techniques with step-by-step video lessons — from framing and masonry to blueprint reading.
        </p>
        <div className="page-image-container page-5-image">
          <img src="/culinary-school-screenshot.png" alt="Build School Screenshot" className="page-screenshot" />
        </div>
      </>
    ),
    pageNumber: 5
  ...
  // Page 6 - Hardhat Hub
  {
    ...
    content: (
      <>
        <p className="page-content-text">
          Connect with peers, find local materials suppliers and lumber yards, and share techniques with fellow builders.
        </p>
        <div className="page-image-container page-6-image">
          <img src="/chefs-corner-screenshot.png" alt="Hardhat Hub Screenshot" className="page-screenshot" />
        </div>
      </>
    ),
    pageNumber: 6
  },
  // Page 7 - Foreman Frank
  {
    title: "Foreman Frank",
    content: (
      <>
        <p className="page-content-text">
          Your AI construction assistant, ready to help with project planning, code compliance, material estimates, and troubleshooting.
        </p>
        <div className="page-image-container page-7-image">
          <img src="/chef-freddie-screenshot.png" alt="Foreman Frank Screenshot" className="page-screenshot" />
        </div>
      </>
    ),
    pageNumber: 7
      ...
      <>
        <div className="faq-content">
          <ul className="faq-list">
            ...
            PorkChop is purpose-built for construction education — it understands building codes, safety regulations, and trade-specific workflows.</li>
            
            <li><strong>Is this just a video library?</strong><br />
            We combine it all — project tracking, blueprint management, supplier locator, and AI-powered education.</li>
            
            <li><strong>How is this different?</strong><br />
            It adapts to your skill level, the type of builds you work on, and your jurisdiction's codes in real-time.</li>
          </ul>
        </div>
      </>
    ),
...
const FlippableBlueprints: React.FC = () => {
...
export default FlippableBlueprints;

...
const StudentProgressDashboard: React.FC = () => {
  ...
  const activeLiveSessions = [
    ...
    },
    {
      ...
      dishName: 'Pressure Regulator Calibration',
      culture: 'Service Plumbing',
      viewers: 35,
      thumbnail: '📏'
    },
    {
  ...
  const getPostBorderColor = (type: string) => {
    switch (type) {
      case 'fit': return 'border-blue-400';
      case 'material': return 'border-green-400';
    ...
    <div className="mb-8 mx-auto">
      ...
      <div className="bg-white rounded-lg shadow-lg border-4 border-maineBlue p-4 lg:p-6 w-full max-w-6xl mx-auto">
        ...
        <div className={`${activeMobileTab === 'home' ? 'block' : 'hidden'} lg:block`}>
          ...
          <div className="text-center mb-6">
            <h1 className="text-4xl font-retro text-maineBlue mb-2">Pipefitter Dashboard</h1>
          ...
          <div className="mb-4 p-3">
            ...
            >
              ...
              <h3 className="text-sm font-bold font-retro">{t('myVan.title')}</h3>
            </Link>
            
            <Link
              to="/plumbing/my-pipebook"
            ...
            >
              <div className="mb-3 text-4xl">📖</div>
              <h3 className="text-sm font-bold font-retro">{t('myPipeBook.title')}</h3>
            </Link>
            
            <Link
              to="/plumbing/pipe-lounge"
            ...
            >
              <div className="mb-3 text-4xl">🔧</div>
              <h3 className="text-sm font-bold font-retro">{t('pipeLounge.title')}</h3>
            </Link>
            
            <Link
              to="/plumbing/plumbing-school"
            ...
            >
              <div className="mb-3 text-4xl">🚿</div>
              <h3 className="text-sm font-bold font-retro">{t('plumbingSchool.title')}</h3>
            </Link>
          </div>
          </div>
        </div>
      ...
      {curriculumModalOpen && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-lg shadow-lg border-4 border-black p-6 w-full max-w-2xl max-h-[85vh] lg:max-h-[80vh] overflow-y-auto">
      ...
      {liveSessionModalOpen && currentLiveSession && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-2 sm:p-4">
          <div className="bg-white rounded-lg shadow-lg border-4 border-black overflow-hidden w-full h-full sm:w-5/6 sm:h-auto sm:max-h-[95vh] lg:w-2/3 lg:max-h-[85vh] lg:max-h-[80vh] min-h-[680px] relative flex flex-col">
            <div className="flex-1 flex flex-col overflow-hidden">
              <div className="p-4 bg-lobsterRed text-black font-retro text-center sticky top-0 z-20">
                ...
                <p className="text-center text-black mt-2 sm:mt-3 text-xs sm:text-sm">
                  Hosted by {currentLiveSession.hostName} • {currentLiveSession.culture} Focus
                </p>
              </div>

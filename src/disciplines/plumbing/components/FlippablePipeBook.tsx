...
const PAGES = [
    ...
    content: (
      <div className="toc-content">
        <ul className="toc-list">
          ...
          <li>My Van (Page 3)</li>
          <li>My Pipebook (Page 4)</li>
          <li>Plumbing School (Page 5)</li>
          <li>Pipe Lounge (Page 6)</li>
          <li>Pete the Plumber (Page 7)</li>
  ...
  // Page 5 - Plumbing School
  {
    title: "Plumbing School",
    content: (
      <>
        <p className="page-content-text">
  ...
  // Page 7 - Pete the Plumber
  {
    title: "Pete the Plumber",
    content: (
      <>
        <p className="page-content-text">
      ...
      <>
        <div className="faq-content">
          <ul className="faq-list">
            ...
            PorkChop is purpose-built for plumbing education — it knows the NEC, local codes, and trade-specific workflows.</li>
            
            <li><strong>Is this just a video library?</strong><br />
            We combine it all — project tracking, code compliance tools, supply house locator, and AI-powered education.</li>
            
            <li><strong>How is this different?</strong><br />
            It adapts to your skill level, your jurisdiction, and the type of work you do in real-time.</li>
          </ul>
        </div>
      </>
    ),

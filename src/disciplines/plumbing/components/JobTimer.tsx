...
const CookingTimer: React.FC<CookingTimerProps> = ({ servingSize, setServingSize }) => {
  ...
  const presetTimers = [
    { label: 'Fixture Layout', minutes: 8 },
    { label: 'Line Prep', minutes: 12 },
    { label: 'Pipe Fit', minutes: 6 },
    { label: 'Pressure Test', minutes: 10 },
    { label: 'Final Leak Check', minutes: 4 },
  ];
    ...
    <div className="space-y-4">
      ...
      <div className="bg-sand p-4 rounded-lg border border-black">
        ...
        <div className="text-xs text-gray-500">
          *1 tech represents one learner assigned to the plumbing job.
        </div>
        <div className="text-xs text-gray-400 mt-1">
          Time recommendations scale by crew size for realistic job pacing.
        </div>
      </div>

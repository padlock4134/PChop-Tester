  ...
  return (
    <>
      <button
        ...
        onClick={() => setOpen(o => !o)}
        aria-label="Open Pipe Freddie AI Assistant"
      >
      ...
      {open && (
        <div className="fixed bottom-24 right-6 bg-white border border-maineBlue rounded shadow-lg p-4 w-80 z-50">
          <div className="flex justify-between items-center mb-2">
            <span className="font-bold text-maineBlue">Pipe Freddie</span>
            <button onClick={() => setOpen(false)} className="text-gray-500">✕</button>
          </div>
          <div className="text-gray-700 mb-2">Hi! I'm Pipe Freddie. Ask me anything about plumbing, fittings, or pipe work!</div>

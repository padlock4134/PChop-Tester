...
const MySpecSheets = () => {
  ...
  const handleDeleteCollection = (collectionId: string) => {
    if (window.confirm(t('mySpecSheets.deleteConfirm'))) {
  ...
  return (
    <div className="w-full mt-4">
      ...
      <div className="mt-2 text-xs text-gray-500 text-center w-full italic">
        {t('mySpecSheets.scrollToSeeMore')}
      </div>
        ...
        <div className={`lg:w-1/3 ${
          ...
          <div className="bg-white rounded-lg shadow-lg border-4 border-maineBlue overflow-hidden w-full h-full">
            ...
            <div className="p-4">
              ...
              <div className="mb-6">
                <h4 className="font-bold text-maineBlue mb-3">📋 {t('mySpecSheets.myCollections')}</h4>

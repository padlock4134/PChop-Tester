...
const CookingTimer: React.FC<CookingTimerProps> = ({ servingSize, setServingSize }) => {
  ...
  const presetTimers = [
    { label: 'System Inspection', minutes: 8 },
    { label: 'Refrigerant Check', minutes: 12 },
    { label: 'Airflow Test', minutes: 6 },
    { label: 'Electrical Trace', minutes: 10 },
    { label: 'Final Performance Test', minutes: 4 },
  ];
    ...
    <div className="space-y-4">
      ...
      <div className="bg-sand p-4 rounded-lg border border-black">
        ...
        <div className="text-xs text-gray-500">
          *1 tech represents one learner assigned to the service call.
        </div>
        <div className="text-xs text-gray-400 mt-1">
          Time recommendations scale by team size for realistic service pacing.
        </div>
      </div>

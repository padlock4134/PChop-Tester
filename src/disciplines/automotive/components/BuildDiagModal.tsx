...
import { fetchCookbook } from '../modules/manualSupabase';
      ...
      <div className="bg-white rounded-lg shadow-xl border-4 border-maineBlue max-w-4xl w-full mx-4 max-h-[85vh] lg:max-h-[80vh] flex flex-col" onClick={e => e.stopPropagation()}>
        <div className="p-4 lg:p-6 flex-1 overflow-hidden flex flex-col">
          ...
          <div className="flex justify-between items-center mb-4">
            <h2 className="text-xl lg:text-2xl font-bold text-maineBlue font-retro">🔧 Build Work Order</h2>
            <button 
              onClick={onClose}
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between pt-4 border-t flex-shrink-0 gap-3">
            ...
            <div className="flex flex-col sm:flex-row gap-2 w-full sm:w-auto">
              ...
              <button
                ...
                className="w-full sm:w-auto px-4 py-2 rounded font-bold transition-colors bg-maineBlue text-seafoam hover:bg-seafoam hover:text-maineBlue border border-maineBlue min-h-[44px]"
              >
                🔎 {bt('findMarkets')}
              </button>
            </div>

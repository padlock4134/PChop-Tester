...
const Profile = () => {
  ...
  const talentTrees = {
    'Engine Master': [
      { name: 'Engine Savant', icon: FireIcon, unlockLevel: 10, description: 'Increased efficiency when diagnosing engine problems' },
      { name: 'Diagnostics Expert', icon: ShieldCheckIcon, unlockLevel: 14, description: 'Enhanced ability to read diagnostic codes and identify issues' },
      { name: 'Mechanical Will', icon: StarIcon, unlockLevel: 25, description: 'Improved precision in mechanical repairs and adjustments' },
      { name: 'Precision Pro', icon: StarIcon, unlockLevel: 30, description: 'Master torque specifications and assembly procedures' },
      { name: 'Tool Master', icon: SparklesIcon, unlockLevel: 36, description: 'Expert use of specialized automotive tools and equipment' },
      { name: 'System Specialist', icon: CakeIcon, unlockLevel: 42, description: 'Deep understanding of integrated engine systems' },
      { name: 'Automotive Guru', icon: StarIcon, unlockLevel: 48, description: 'Advanced knowledge of engine performance tuning' },
      { name: 'Steel Shield', icon: ShieldCheckIcon, unlockLevel: 55, description: 'Exceptional durability and reliability in engine work' },
      { name: 'Engine Master', icon: TrophyIcon, unlockLevel: 60, description: 'Complete mastery of all engine systems and repairs' },
    ],
    'Electronics Expert': [
      { name: 'Circuit Tamer', icon: FireIcon, unlockLevel: 10, description: 'Improved ability to troubleshoot electrical circuits' },
      { name: 'Wire Master', icon: SparklesIcon, unlockLevel: 14, description: 'Expert wiring and connector repair skills' },
      { name: 'Voltage Champion', icon: StarIcon, unlockLevel: 25, description: 'Advanced electrical system diagnostics' },
      { name: 'Sensor Specialist', icon: StarIcon, unlockLevel: 30, description: 'Master sensor testing and calibration' },
      { name: 'Diagnostic Dynamo', icon: SparklesIcon, unlockLevel: 36, description: 'Expert use of multimeters and diagnostic equipment' },
      { name: 'ECU Expert', icon: CakeIcon, unlockLevel: 42, description: 'Deep understanding of engine control modules' },
      { name: 'Power Pro', icon: StarIcon, unlockLevel: 48, description: 'Advanced knowledge of power distribution systems' },
      { name: 'Circuit Guardian', icon: ShieldCheckIcon, unlockLevel: 55, description: 'Exceptional electrical system reliability' },
      { name: 'Electronics God', icon: TrophyIcon, unlockLevel: 60, description: 'Complete mastery of automotive electronics' },
    ],
    'Transmission Specialist': [
      { name: 'Gear Whisperer', icon: CakeIcon, unlockLevel: 10, description: 'Enhanced ability to diagnose transmission issues' },
      { name: 'Shift Oracle', icon: ShieldCheckIcon, unlockLevel: 14, description: 'Expert understanding of shift patterns and timing' },
      { name: 'Clutch Control', icon: StarIcon, unlockLevel: 25, description: 'Master clutch adjustment and replacement' },
      { name: 'Transmission Pro', icon: StarIcon, unlockLevel: 30, description: 'Advanced transmission rebuild skills' },
      { name: 'Drivetrain Dynamo', icon: CakeIcon, unlockLevel: 36, description: 'Expert knowledge of complete drivetrain systems' },
      { name: 'Fluid Finesse', icon: SparklesIcon, unlockLevel: 42, description: 'Master transmission fluid service and diagnostics' },
      { name: 'Gear Genius', icon: CakeIcon, unlockLevel: 48, description: 'Advanced gear ratio and performance optimization' },
      { name: 'Transmission Titan', icon: AcademicCapIcon, unlockLevel: 55, description: 'Exceptional transmission repair expertise' },
      { name: 'Transmission Master', icon: TrophyIcon, unlockLevel: 60, description: 'Complete mastery of all transmission types' },
    ],
  };
  ...
  const reportCategories = [
    ...
    },
    {
      ...
      reports: [
        { title: '🍳 Task Performance', description: 'Analyze task success rates and training outcomes', metrics: ['Recipe success rates', 'Common modifications', 'Ingredient substitutions', 'Difficulty ratings'], color: 'orange' },

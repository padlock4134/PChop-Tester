...
interface VideoModalProps {
  ...
  repairGuideId?: string;   // Optional repair guide ID if this is a repair guide tutorial
}

const VideoModal: React.FC<VideoModalProps> = ({ open, onClose, title, videoUrl, tutorialId, repairGuideId }) => {

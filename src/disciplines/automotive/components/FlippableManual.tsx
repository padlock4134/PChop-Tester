...
const PAGES = [
    ...
    content: (
      <div className="toc-content">
        <ul className="toc-list">
          ...
          <li>My Garage (Page 3)</li>
          <li>My Manual (Page 4)</li>
          <li>Auto School (Page 5)</li>
          <li>Gearhead Lounge (Page 6)</li>
          <li>Gus the Mechanic (Page 7)</li>
  ...
  // Page 6 - Gearhead Lounge
  {
    title: "Gearhead Lounge",
    content: (
      <>
        <p className="page-content-text">
  ...
  // Page 7 - Gus the Mechanic
  {
    title: "Gus the Mechanic",
    content: (
      <>
        <p className="page-content-text">
      ...
      <>
        <div className="faq-content">
          <ul className="faq-list">
            ...
            PorkChop is purpose-built for automotive education — it understands OBD codes, TSBs, and trade-specific workflows.</li>
            
            <li><strong>Is this just a video library?</strong><br />
            We combine it all — repair tracking, diagnostic tools, parts locator, and AI-powered education.</li>
            
            <li><strong>How is this different?</strong><br />
            It adapts to your skill level, the makes and models you work on, and the type of repairs you do in real-time.</li>
          </ul>
        </div>
      </>
    ),

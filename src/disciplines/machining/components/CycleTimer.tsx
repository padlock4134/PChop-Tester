...
const CookingTimer: React.FC<CookingTimerProps> = ({ servingSize, setServingSize }) => {
  ...
  const presetTimers = [
    { label: 'Machine Setup', minutes: 8 },
    { label: 'Tool Offset Check', minutes: 12 },
    { label: 'First Article', minutes: 6 },
    { label: 'Production Run', minutes: 10 },
    { label: 'Final QC Sweep', minutes: 4 },
  ];
  ...
  const addTimer = (minutes: number, label: string) => {
    ...
    const newTimer: Timer = {
      ...
      label: `${label} (${servingSize} operators)`,

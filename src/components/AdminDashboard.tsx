        ...
        {activeTab === 'overview' && (
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="bg-blue-50 border-4 border-blue-400 rounded-lg p-6 text-center">
              ...
              <div className="bg-green-50 border-4 border-green-400 rounded-lg p-6 text-center">
              ...
              <div className="bg-orange-50 border-4 border-orange-400 rounded-lg p-6 text-center">
              ...
              <div className="bg-purple-50 border-4 border-purple-400 rounded-lg p-6 text-center">

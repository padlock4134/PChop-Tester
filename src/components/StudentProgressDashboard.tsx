    ...
    <div className="mb-8 mx-auto">
      ...
      {liveSessionModalOpen && currentLiveSession && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-2 sm:p-4">
          <div className="bg-white rounded-lg shadow-lg border-4 border-black overflow-hidden w-full h-full sm:w-5/6 sm:h-auto sm:max-h-[90vh] lg:w-2/3 lg:max-h-[85vh] min-h-[620px] relative flex flex-col">
